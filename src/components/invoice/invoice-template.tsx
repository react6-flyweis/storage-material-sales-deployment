...
import type { InvoiceDocument, PaymentScheduleDocument } from "@/modules/invoices/invoices.api";
...
export default function InvoiceTemplate({ invoice, paymentSchedule }: InvoiceTemplateProps) {
  const items =
